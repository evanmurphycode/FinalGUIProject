...
# - Validate Save, Linear Projection, & Add Data Buttons?! (done)
# - Activate Add Data Function/Button (done)
# - Format Output box bigger (done)
# - Make it look pretty (Stephen's job!)
...
def load_all_bacteria():
    ...
    bacteria_defaults = ['Coccus', 'Psilocybin', 'Bacillus', 'Spirillum', 'Rickettsia', 'Mycoplasma']
...
def load_all_medicine():
    ...
    medicine_defaults = ['Control', 'Temperance', 'Formula-FD102', 'Formula-FD201', 'Formula-FD202', 'Formula-FD505']
...
date_entry.grid(row=0, column=1, padx=8, pady=(8, 0), ipady=4)
...
culture_ID_entry.grid(row=1, column=1, padx=8, pady=(8, 0), ipady=4)
...
bacteria_menu.grid(row=2, column=1, padx=8, pady=(8, 0), ipady=4)
...
medicine_menu.grid(row=3, column=1, padx=8, pady=(8, 0), ipady=4)
...
morning_reading_entry.grid(row=0, column=1, padx=8, pady=(8, 0), ipady=4)
...
evening_reading_entry.grid(row=1, column=1, padx=8, pady=(8, 0), ipady=4)
...
#Daily Culture Readings Confirmation Button configuration
b1 = Button(culture_readings_frame, text="Confirm", command=confirm_button_function)
b1.grid(row=5, column=1, padx=10, pady=10, ipady=4, sticky=NSEW, columnspan=1)
...
b2.grid(row=0, column=0, padx=16, pady=(16, 0), ipady=4, sticky="EW")
...
b3 = Button(button_frame, text="Linear Projection", command=linear_projection_button_function, width=15)
b3.grid(row=1, column=0, padx=16, pady=(16, 0), ipady=4, sticky="EW")
...
add_data_frame.grid(row=1, column=0, padx=16, columnspan=2)
...
new_Bact_Med.grid(row=0, column=0, padx=(16, 28), pady=12, sticky="NW")

#Add data button
b4 = Button(add_data_frame, text="Add Data", command=add_data_button_function, width=15)
b4.grid(row=0, column=1, padx=(28, 8), pady=8, ipady=4, sticky="W")
...
b5 = Button(button_frame, text="Exit", command=exit_button_function, width=15)
b5.grid(row=2, column=0, padx=16, pady=(16, 0), ipady=4, sticky="EW")
